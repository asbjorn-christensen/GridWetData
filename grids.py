...
class DMIGrid_2D(LonLatGrid, DMI_wetpoint_data):
    #  -----------------------------------------------------
...
#         
class DMIGrid_3D(LonLatZGrid, DMI_wetpoint_data):
    #  -----------------------------------------------------
    ## constructor from file data
    #  @param self        The object pointer
    #  @param grid_desc   file name of grid descriptor in netCDF format
    ...
    def __init__(self, grid_desc):
        ...
        self.surf_grid = DMIGrid_2D(grid_desc) # compositional relation, no heritance
...
if __name__ == "__main__":
    _verbose = True
    ## g2D = DMIGrid_2D(os.path.join("DMI_data", "ns_grid.nc"))
